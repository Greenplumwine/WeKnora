---
title: 腾讯云轻量镜像
tags: [开发部署, 云镜像, 腾讯云, Lighthouse, CVM]
aliases: [tencent-lighthouse, 腾讯云镜像, Lighthouse镜像]
---

# 腾讯云轻量应用服务器 / CVM 镜像制作指南

> **前置阅读**：通用脚本与流程见 [`scripts/cloud-image/README.md`](../../../scripts/cloud-image/README.md)。本文只补充腾讯云平台专属的操作步骤。云镜像打包的总览见 [云镜像打包](云镜像打包.md)。
