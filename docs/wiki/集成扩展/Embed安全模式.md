---
title: Embed安全模式
tags: [集成扩展, Embed, 安全, Token, 认证]
aliases: [embed-secure-mode, 安全模式, SecureMode]
---
...
若 embed 使用[独立子域](Embed子域部署.md)，**两条都要加**（embed 源站 + 业务后端源站）。
...
- [Embed子域部署](Embed子域部署.md) - 可选的独立子域部署方案
