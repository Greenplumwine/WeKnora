...
- [数据源导入开发](数据源导入开发.md) - 飞书数据源同步（共享飞书应用凭证）
- [MCP功能使用说明](../核心功能/MCP功能使用说明.md) - Agent 可调用 MCP 工具
- [Agent技能系统](../核心功能/Agent技能系统.md) - Agent 可使用 Skills 技能
- [内置模型管理](../核心功能/内置模型管理.md) - Agent 模型配置
- [添加网络搜索引擎](添加网络搜索引擎.md) - 类似的适配器扩展模式
- [集成向量数据库](集成向量数据库.md) - 类似的适配器扩展模式
...
- [数据源导入开发](数据源导入开发.md) - 同样涉及飞书集成，可共享应用凭证
