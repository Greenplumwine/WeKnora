---
title: MCP工具人工审核
tags: [核心功能, MCP, 安全, 人工审核, 危险调用]
aliases: [mcp-approval, MCP审核, 工具审核, tool-approval]
---
...
- [MCP功能使用说明](MCP功能使用说明.md) - MCP 服务的用户操作指南
- [内置MCP服务管理](内置MCP服务管理.md) - 内置 MCP 服务的系统级管理
...
- [MCP功能使用说明](MCP功能使用说明.md) - MCP 服务操作
- [内置MCP服务管理](内置MCP服务管理.md) - 内置 MCP 管理
